PROJECT_NAME=content_selection
...
#script.sh
rsync --include './' --include '*.py' --exclude '*' --exclude 'env/' --exclude 'data/' --delete --archive --verbose --compress --update -e ssh $LOCAL/  $SERVER:$REMOTE_DIR/
rsync --include './' --include '*.txt' --exclude '*' --exclude 'env/' --exclude 'data/' --delete --archive --verbose --compress --update -e ssh $LOCAL/  $SERVER:$REMOTE_DIR/
rsync --include './' --include '*.sh' --exclude '*' --exclude 'env/' --exclude 'data/' --delete --archive --verbose --compress --update -e ssh $LOCAL/  $SERVER:$REMOTE_DIR/
rsync --include './' --include '*.json' --exclude '*' --exclude 'env/' --exclude 'data/' --delete --archive --verbose --compress --update -e ssh $LOCAL/  $SERVER:$REMOTE_DIR/
